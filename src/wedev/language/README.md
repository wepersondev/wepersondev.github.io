...
결론적으로 저희는 Full Stack, 효율성, 안정성, 협업, 스타트업, 러닝커브, 인력 수급등 여러가지를 고려하여 TypeScript을 주로 사용하고 일부 JavaScript와 Python을 사용합니다. 각 플렛폼별 예외처리를 위해서 Java나 Swift등도 같이 사용합니다. 이러한 언어를 사용하게 된 배경과 프레임워크등을 이어서 설명 예정입니다.
