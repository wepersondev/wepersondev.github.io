...
먼저 최신 트렌드 기술들이 왜 트렌드 기술이 되었는가를 이해해야 합니다. 대부분의 요즘 트렌드 기술들은 주로 생산성과 유지보수에 초점이 맞춰져 있습니다. 무작정 최신 기술을 도입하기 보다는 **어떻게 생산성과 유지보수성을 높일 것인가**에 무게를 두어야 합니다. 아쉽게도 **기술력은 기술에서 나오는 것이 아니라 경험에서 나옵니다.**


## 스타트업의 기술 선정

성공하는 스타트업이 되기 위해서는 다음 두 가지를 최우선에 염두해 두어야 합니다.
...
현실적으로 신입/경력을 떠나서 좋은 개발자 한분 모시기가 힘든 스타트업 입장에서 신입 개발자는 고급지게, 고급 개발자는 더 고급지게(?) 만들어야 하는 숙명을 가지고 다음과 같은 기술 선정 기준을 선택하였습니다.
...
기술 선택은 팀과 비즈니스를 고려해야 한다.


:::tip
객관적이나 중립적이지 않고 필자의 지식과 경험을 바탕으로 우리 회사, 우리 팀에 맞는 기술이니까 참고해라.
...
필자의 기술 스택 정리
대략 20년 경력, 스타트업, 대기업, 기술한 내용들은 대부분 단순히 할 줄 아는 수준이 아니고 다년간 상용화까지 했던 기술만 추린 것, 분야 하나 하나 심도 있게 얘기 가능
